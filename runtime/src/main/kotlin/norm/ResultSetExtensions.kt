...
operator fun ResultSet.get(columnName: String): Any? =
    this.getObject(columnName) // TODO specific type methods instead of getObject
...
fun ResultSet.rowAsList(columnNames: List<String> = getColumnNames()): List<Any?> =
    // TODO Can overload for column indexes instead of name
